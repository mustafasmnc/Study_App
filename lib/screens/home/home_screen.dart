    ...
    return Scaffold(
      body: GetBuilder<ThemeController>(
        builder: (themeController) =>
            GetBuilder<MyZoomDrawerController>(builder: (_) {
          //MyZoomDrawerController _myZoomDrawerController=MyZoomDrawerController();
          ...
          return ZoomDrawer(
            ...
            menuBackgroundColor: customMenuColor(context),
